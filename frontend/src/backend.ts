...
import type { ExternalBlob as _ExternalBlob, StudentId as _StudentId, StudentProfile as _StudentProfile, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAttendanceByClass(arg0: ClassId): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttendanceByClass(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAttendanceByDateRange(arg0: Time, arg1: Time): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttendanceByDateRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFaceRecognitionData(arg0: StudentId): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFaceRecognitionData(arg0);
    ...
    async getStudentProfile(arg0: StudentId): Promise<StudentProfile | null> {
        if (this.processError) {
            try {
    ...
    async recordAttendance(arg0: StudentId, arg1: ClassId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerStudentProfile(arg0: StudentProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerStudentProfile(await to_candid_StudentProfile_n22(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStudentProfile(arg0: StudentProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStudentProfile(await to_candid_StudentProfile_n22(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudentProfile]): Promise<StudentProfile | null> {
    return value.length === 0 ? null : await from_candid_StudentProfile_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        faceData: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.faceData)
    };
}
...
async function to_candid_StudentProfile_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StudentProfile): Promise<_StudentProfile> {
...
async function to_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        studentId: value.studentId,
        name: value.name,
        faceData: await to_candid_ExternalBlob_n24(_uploadFile, _downloadFile, value.faceData)
    };
}
